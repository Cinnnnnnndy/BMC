...
export const HARDWARE_COMPONENTS: HardwareComponent[] = [
  ...
  // ── Front bay: 12 × 3.5" SAS/SATA HDD (4 columns × 3 rows) ───────────────
  // TaiShan 2280 12×3.5" chassis: drives lie flat (sled), face out the front.
  // Positions are set by chassisLayout (4 cols × 3 rows); grid/size below are
  // placeholders that applyChassisLayout overrides.
  {
    id: 'hdd_0', type: 'HDD', label: '硬盘 #0  4TB SATA', labelEn: 'HDD 0',
    grid: { x: 0.5, y: 0.5, z: 0 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'error',
    busConnections: [
  ...
  {
    id: 'hdd_1', type: 'HDD', label: '硬盘 #1  4TB SATA', labelEn: 'HDD 1',
    grid: { x: 5.7, y: 0.5, z: 0 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ],
    metrics: { temperature: 41, powerWatts: 7 },
    description: '在线 SATA 硬盘 #1，4TB 7200RPM，SMART 自检通过。',
  },
  {
    id: 'hdd_2', type: 'HDD', label: '硬盘 #2  4TB SATA', labelEn: 'HDD 2',
    grid: { x: 10.9, y: 0.5, z: 0 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ],
    metrics: { temperature: 40, powerWatts: 7 },
    description: '在线 SATA 硬盘 #2，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_3', type: 'HDD', label: '硬盘 #3  4TB SATA', labelEn: 'HDD 3',
    grid: { x: 16.1, y: 0.5, z: 0 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ],
    metrics: { temperature: 43, powerWatts: 8 },
    description: '在线 SATA 硬盘 #3，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_4', type: 'HDD', label: '硬盘 #4  4TB SATA', labelEn: 'HDD 4',
    grid: { x: 0.5, y: 0.5, z: 1.4 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    description: '在线 SATA 硬盘 #4，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_5', type: 'HDD', label: '硬盘 #5  4TB SATA', labelEn: 'HDD 5',
    grid: { x: 5.7, y: 0.5, z: 1.4 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'warning',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ],
    metrics: { temperature: 58, powerWatts: 9 },
    description: 'SATA 硬盘 #5：温度偏高（58°C），SMART 预警，建议关注散热。',
  },
  {
    id: 'hdd_6', type: 'HDD', label: '硬盘 #6  4TB SATA', labelEn: 'HDD 6',
    grid: { x: 10.9, y: 0.5, z: 1.4 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    metrics: { temperature: 41, powerWatts: 7 },
    description: '在线 SATA 硬盘 #6，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_7', type: 'HDD', label: '硬盘 #7  4TB SATA', labelEn: 'HDD 7',
    grid: { x: 16.1, y: 0.5, z: 1.4 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ],
    metrics: { temperature: 42, powerWatts: 8 },
    description: '在线 SATA 硬盘 #7，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_8', type: 'HDD', label: '硬盘 #8  4TB SATA', labelEn: 'HDD 8',
    grid: { x: 0.5, y: 0.5, z: 2.8 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    metrics: { temperature: 40, powerWatts: 7 },
    description: '在线 SATA 硬盘 #8，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_9', type: 'HDD', label: '硬盘 #9  4TB SATA', labelEn: 'HDD 9',
    grid: { x: 5.7, y: 0.5, z: 2.8 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    metrics: { temperature: 43, powerWatts: 8 },
    description: '在线 SATA 硬盘 #9，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_10', type: 'HDD', label: '硬盘 #10  4TB SATA', labelEn: 'HDD 10',
    grid: { x: 10.9, y: 0.5, z: 2.8 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    metrics: { temperature: 41, powerWatts: 7 },
    description: '在线 SATA 硬盘 #10，4TB 7200RPM，运行正常。',
  },
  {
    id: 'hdd_11', type: 'HDD', label: '硬盘 #11  4TB SATA', labelEn: 'HDD 11',
    grid: { x: 16.1, y: 0.5, z: 2.8 }, size: { w: 5.08, d: 7.35, h: 1.3 },
    status: 'normal',
    busConnections: [
      { busId: 'sata_main', busType: 'SATA',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    metrics: { temperature: 42, powerWatts: 8 },
    description: '在线 SATA 硬盘 #11，4TB 7200RPM，运行正常。',
  },

  // ── Rear bay: 4 × 2.5" U.2 NVMe (12×3.5" chassis supports up to 4 rear) ──
  {
    id: 'nvme_0', type: 'NVME', label: 'NVMe #0  1.92TB', labelEn: 'NVMe 0',
    grid: { x: 6.8, y: 33, z: 0 }, size: { w: 0.75, d: 5.02, h: 3.49 },
    status: 'normal',
    busConnections: [
    ...
    description: '后置 U.2 NVMe SSD #0，1.92TB，PCIe Gen4 ×4，延迟 < 100 μs。',
  },
  {
    id: 'nvme_1', type: 'NVME', label: 'NVMe #1  1.92TB', labelEn: 'NVMe 1',
    grid: { x: 7.7, y: 33, z: 0 }, size: { w: 0.75, d: 5.02, h: 3.49 },
    status: 'normal',
    busConnections: [
      { busId: 'pcie_main', busType: 'PCIE',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    description: '后置 U.2 NVMe SSD #1，1.92TB，PCIe Gen4 ×4，运行正常。',
  },
  {
    id: 'nvme_2', type: 'NVME', label: 'NVMe #2  1.92TB', labelEn: 'NVMe 2',
    grid: { x: 8.6, y: 33, z: 0 }, size: { w: 0.75, d: 5.02, h: 3.49 },
    status: 'warning',
    busConnections: [
      { busId: 'pcie_main', busType: 'PCIE',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    description: '后置 U.2 NVMe SSD #2，温度偏高（71°C），建议检查散热通道。',
  },
  {
    id: 'nvme_3', type: 'NVME', label: 'NVMe #3  1.92TB', labelEn: 'NVMe 3',
    grid: { x: 9.5, y: 33, z: 0 }, size: { w: 0.75, d: 5.02, h: 3.49 },
    status: 'normal',
    busConnections: [
      { busId: 'pcie_main', busType: 'PCIE',  role: 'slave', connectorPos: 'bottom' },
      { busId: 'pwr_main',  busType: 'POWER', role: 'slave', connectorPos: 'top'    },
    ...
    description: '后置 U.2 NVMe SSD #3，1.92TB，PCIe Gen4 ×4，运行正常。',
  },
